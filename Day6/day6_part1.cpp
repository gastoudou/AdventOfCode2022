...
namespace day_6_part_1
{
	...
	const std::string load_inputs()
	{
		...
		{
			// "mjqjpqmgbljsphdztnvjfqwrcgsmlb" //: after character 7
			// "bvwbjplbgvbhsrlpgdmjqwftvncz" //: after character 5
			// "nppdvjthqldpwncqszvftbrmjlhg" //: after character 6
			// "nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg" //: after character 10
			 "zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw" //: after character 11
		};
		return test_inputs;
#else
...
void day_6_run_part_1()
{
	day_6_part_1::data data;

	day_6_part_1::process( day_6_part_1::load_inputs(), data );
	day_6_part_1::display_result( data );
}